...
export const deployRelayPluginMetadata = async (): Promise<string> => {
  const image =
  ...
  const nft = {
    ...
    name: "Gelato relay",
    description: "Gelate Network is a protocol that automates smart contract executions on Ethereum.",
    properties: {
      version: "1.0",
      source: "https://github.com",
      author: "Gelato Gelatovich",
      audits: [
        {
